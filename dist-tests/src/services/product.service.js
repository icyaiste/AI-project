import { createProduct as createProductRecord, deleteProduct as deleteProductRecord, findProductById, listProducts, replaceProduct as replaceProductRecord, resetProducts, updateProduct as updateProductRecord } from "../repositories/product.repository.js";
...
const validatePrice = (price) => typeof price === "number" && !Number.isNaN(price) && price >= 0;
...
export const getProduct = (idParam) => {
...
export const createProduct = (payload) => {
    const { name, price, currency = "USD", inStock = true } = payload;
...
export const replaceProduct = (idParam, payload) => {
    const parsedId = validateId(idParam);
    if (!parsedId.ok) {
        return parsedId;
    }
...
export const updateProduct = (idParam, payload) => {
    const parsedId = validateId(idParam);
    if (!parsedId.ok) {
        return parsedId;
    }
...
export const removeProduct = (idParam) => {
    const parsedId = validateId(idParam);
    if (!parsedId.ok) {
        return parsedId;
    }
